...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Jun 2022 pada 10.51
...
(5, 1, 1, 2, 'AS0001', 'Handphone', 'Samsung', 5, 'Persandian', 'Kantor Gubernur ', 'Perangkat Jaring', 'Persandian', 1654613396),
...
CREATE TABLE `monitor_rtp` (
  ...
  `real_mulai` date DEFAULT NULL,
  `real_selesai` date DEFAULT NULL,
  `status` varchar(50) NOT NULL,
  `hambatan` varchar(512) DEFAULT NULL,
...
(4, 'Menyediakan dana cadangan untuk membeli smartphone baru apabila kehilangan smartphone', '2022-06-06', '2022-06-13', 'Dana tersedia', 'Persandian', 900000, '2022-06-07', '2022-06-14', 'Close', 'Tidak ada hambatan', 'Tidak ada', 'file_admin.zip');
...
(4, 'Smartphone hilang/dicuri', 'Kecopetan di kereta', 'Tidak bisa menghubungi teman untuk agenda pertemuan', 5, 4, 20, '', 'Melakukan backup data dan kontak di harddisk eksternal', 'Risiko dikurangi (mitigasi)', 5, 1);
...
--
ALTER TABLE `risiko`
  MODIFY `id_risiko` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
