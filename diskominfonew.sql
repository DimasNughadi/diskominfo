...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2022 at 09:13 AM
...
(12, 1, 1, 1, 'AS0005', 'meja rapat', 'Aptika', 6, 'persandian', 'kantor persandian', 'Perangkat Jaringan', 'persandian', 1655559563),
(14, 1, 3, 2, 'L00001', 'License Ms.Office', 'Microsoft', 1, 'Bidang Aptika', 'Gedung Aptika', 'license', 'Pegawai Aptika', 1656312872);
...
(3, 'ikhlaskan', '2022-06-15', '2022-06-16', 'Coba', 'Persandian', 100000, 2022, 2022, 'Close', 'Coba', 'Coba', ''),
(4, 'Coba', '2022-06-20', '2022-06-24', 'Coba', 'Persandian', 2000000, 0, 0, 'Open', '', '', '');
...
(2, 'Penonaktifan smartphone yang tidak tepat', 'Penonaktifan smartphone yang tidak tepat', 'Data rahasia tersebar luas di masyarakat', 5, 5, 25, '', 'Menghapus data di folder sampah (recycle bin)', 'Risiko ditransfer ke pihak lain', 5, 1, 2022),
(3, 'Smartphone hilang/dicuri', 'Coba Edit', 'Coba Edit', 3, 1, 3, '', 'Coba Edit', 'Coba Edit', 5, 1, 2022),
(4, 'patah', 'coba', 'coba', 4, 2, 8, '', 'coba', 'coba', 12, 1, 2022),
(5, 'patah', 'coba', 'coba', 5, 3, 15, '', 'coba', 'coba', 12, 1, 2022),
(6, 'konslet', 'coba', 'coba', 4, 4, 16, '', 'coba', 'coba', 7, 1, 2022),
(7, 'terbakar', 'coba', 'coba', 4, 4, 16, '', 'cobq', 'coba', 7, 1, 2022),
(8, 'coba', 'coba', 'coba', 3, 5, 15, '', 'coba', 'coba', 14, 1, 2022);
...
(45, 'DimasN', '$2y$10$nx62IhjSs2BTwjepgNeKg.Jlp4mJoYZQ5yYuKq2cdhC/lPPrmQZK.', 'Aptika', 'Active', 2),
(48, 'aldo', '$2y$10$F1JsYmQ7lx.F.XEjtF/PceNO2aJY3SoJErWzS8X4U3Qgvnd5Nb8qa', 'Aptika', 'Active', 2);
