                                ...
                                <form action="" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="id_bidang" value="<?= $bidang['id_bidang']; ?>" id="id_bidang">
                                            <input type="text" class="form-control" name="nama_bidang" value="<?= $bidang['nama_bidang']; ?>" id="nama_bidang" placeholder="Masukkan Nama Bidang">
                                            <?= form_error('nama_bidang', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName">Lokasi</label>
                                            <input type="text" class="form-control" name="lokasi" value="<?= $bidang['lokasi']; ?>" id="lokasi" placeholder="Masukkan lokasi">
