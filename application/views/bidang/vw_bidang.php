										...
										<tbody>
											...
											<?php foreach ($bidang as $us) : ?>
												<tr>
													...
													<td>
														<!-- /.modal -->
														<button type="button" class="btn btn-success btn-sm" <?php echo $us['id_bidang']; ?>>
															<i class="ti-pencil"></i>
														</button>
															...
															<div class="modal-dialog">
																<div class="modal-content bg-danger">
																	...
																	<div class="modal-footer justify-content-between">
																		...
																		<a href="<?= base_url('Bidang/hapus/') . $us['id_bidang']; ?>" class="btn btn-outline-light">Simpan Perubahan</a>
																	</div>
																</div>
																<!-- /.modal-content -->
															</div>
