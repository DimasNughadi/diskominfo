                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Ubah Data Jenis Aset</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <form action="" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="id_jenis_aset" value="<?= $jenisaset['id_jenis_aset']; ?>" id="id_jenis_aset">
                                            <input type="text" class="form-control" name="nama_jenis_aset" value="<?= $jenisaset['nama_jenis_aset']; ?>" id="nama_jenis_aset" placeholder="Masukkan Nama Jenis Aset">
