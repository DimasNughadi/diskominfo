                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Ubah Data Aset</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="" method="POST">
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" name="id_user" value="<?= $aset['id_user']; ?>" id="id_user" readonly>
                                        <label for="exampleInputName">User</label>
                                        <input type="text" class="form-control" name="nama_user" value="<?= $aset['id_user']; ?>" id="id_user" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_aset" value="<?= $aset['no_aset']; ?>" id="no_aset" placeholder="Masukkan Nomor Aset">
                                        <?= form_error('no_aset', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName">Nama Aset</label>
                                        <input type="text" class="form-control" name="nama_aset" value="<?= $aset['nama_aset']; ?>" id="nama_aset" placeholder="Masukkan Nama aset">
                        ...
                        <div class="card card-success">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="merk_aset" value="<?= $aset['merk_aset']; ?>" id="merk_aset" placeholder="Masukkan Owner Aset">
                                    <?= form_error('merk_aset', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName">Qty</label>
                                    <input type="number" class="form-control" name="qty" value="<?= $aset['qty']; ?>" id="qty" placeholder="Masukkan Jumlah  Aset">
                                    <?= form_error('qty', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName">Owner Aset</label>
                                    <input type="text" class="form-control" name="owner_aset" value="<?= $aset['owner_aset']; ?>" id="owner_aset" placeholder="Masukkan Owner Aset">
                                    <?= form_error('owner_aset', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName">Lokasi Aset</label>
                                    <input type="text" class="form-control" name="lokasi_aset" value="<?= $aset['lokasi_aset']; ?>" id="lokasi_aset" placeholder="Masukkan Lokasi Aset">
                                    <?= form_error('lokasi_aset', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName">Subclass</label>
                                    <input type="text" class="form-control" name="subclass_aset" value="<?= $aset['subclass_aset']; ?>" id="subclass_aset" placeholder="Masukkan Subclass Aset">
                                    <?= form_error('subclass_aset', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName">Pengguna</label>
                                    <input type="text" class="form-control" name="used_by" value="<?= $aset['used_by']; ?>" id="used_by" placeholder="Masukkan Pengguna Aset">
