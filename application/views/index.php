			...
			<div class="nano-content">
				<ul>
					<div class="logo"><a href="index.html">
							<!-- <img src="<?=base_url('assets/')?>images/logo.png" alt="" /> --><span>Focus</span></a>
					</div>
							...
							<div class="card">
								...
								<div class="recent-comment m-t-15">
									<div class="media">
										<div class="media-left">
											<a href="#"><img class="media-object"
													src="<?=base_url('assets/')?>images/avatar/1.jpg" alt="..."></a>
										</div>
									...
									<div class="media">
										<div class="media-left">
											<a href="#"><img class="media-object"
													src="<?=base_url('assets/')?>images/avatar/2.jpg" alt="..."></a>
										</div>
										<div class="media-body">
									...
									<div class="media">
										<div class="media-left">
											<a href="#"><img class="media-object"
													src="<?=base_url('assets/')?>images/avatar/3.jpg" alt="..."></a>
										</div>
										<div class="media-body">
